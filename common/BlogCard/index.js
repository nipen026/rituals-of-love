        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4">
            {BlogJson.map((items, index) => {
              const backgroundImageClass = `url('/assets/images/blog-${
                index + 1
              }.jpg')`;
              return (
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="relative text-white z-10">
                        ...
                        <Link
                          href={`/blog/${items.id}`}
                          className="bg-white shadow-2xl transition duration-150 ease-out text-[#002642] hover:bg-[#002642] hover:text-white p-3 rounded-lg inline-flex items-center"
                        >
                          Learn More
                          <svg
