    ...
    <>
      <section class="text-gray-600 body-font">
        <div
          ...
          class="bg-cover bg-center h-[calc(100vh-70px)] mx-auto flex items-center flex-wrap"
        >
          ...
          <div class=" mx-auto">
            ...
            >
              <div class="text-center relative z-10 max-w-[70%] mx-auto">
                <h5 class="text-[40px] text-white font-medium title-font font-cursive mb-2 ">
                  {result?.title}
                </h5>
              </div>
            </div>
